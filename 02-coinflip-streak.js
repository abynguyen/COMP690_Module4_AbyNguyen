...
// Declare variable and don't initialize 
let coinFlip;

// Use a do while loop to assign a random number using the math formula.
do {
  ...
  // Continue logic until the random coin flip becomes 1 (Tails)
} while (coinFlip === 0);   